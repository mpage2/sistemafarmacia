...
public Object[] GestionarDetalleVenta(){
        Object[] fila =  {idDetalleVenta,idCabeceraVenta,idProducto,nombre,cantidad,precioUnitario,subtotal,descuento,igv,totalPagar,estado}; 
        return fila;
    } 
